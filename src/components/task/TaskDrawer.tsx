              ...
              >
                <div style={{ display: 'flex', gap: 8, alignItems: 'flex-end' }}>
                  <textarea
                    ...
                    rows={2}
                    className="flex-1 px-3 py-2 text-sm rounded-lg resize-none focus-visible:ring-1 focus-visible:ring-[#3189FF]"
                    style={{
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            >
              <textarea
                ...
                rows={2}
                className="w-full px-3 py-2 text-sm rounded-lg resize-none transition-colors focus-visible:ring-1 focus-visible:ring-[#3189FF]"
                style={{
                  background: 'var(--color-base-150)',
                  border: '1px solid var(--color-base-300)',
                  color: 'var(--color-base-800)',
